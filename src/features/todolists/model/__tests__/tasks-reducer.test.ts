import { v1 } from "uuid"
import { addTask, removeTask, tasksReducer, TasksType, updateTask } from "../tasksSlice"
...
test("correct task should be removed", () => {
    const endState = tasksReducer(startState, removeTask({ taskId: "task1", todolistId: "todolistId1" }))
